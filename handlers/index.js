...
//
internals.printGuessItOutput = (request, reply) => {
    ...
    if (input > 0 && input < 11) {
        ...
        reply(optStatement).code(200); //Return output
    } else {
        reply('Invalid input').code(204); // Return, If invalid input found
    }
};
...
//Defining Interval length for 2 numbers;
